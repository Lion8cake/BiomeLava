...
namespace BiomeLava.Content.Bubbles
{
	...
	{
		public override string Texture => "BiomeLava/Assets/Desert/DesertLavaBubble";
		...
		public override bool Update(Dust dust)
		{
			...
			if (dust.noGravity)
			{
				...
				Lighting.AddLight((int)(dust.position.X / 16f), (int)(dust.position.Y / 16f + 1f), num109 * 0.7f, num109 * 0.4f, num109 * 0.1f);
			}
			else
			{
				...
				Lighting.AddLight((int)(dust.position.X / 16f), (int)(dust.position.Y / 16f), num3 * 0.7f, num3 * 0.4f, num3 * 0.1f);
			}
